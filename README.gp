   This README file is meant to aid in interpreting the accompanying file SHINTANI, which gives examples attached to particular number fields k of the algorithm described in section 6 of the manuscript (abbreviated MS)
...
by A. CAPUÑAY, M. ESPINOZA AND E. FRIEDMAN, submitted to the Journal of Number Theory.
   ...
   The file SHINTANI is a text file meant to be downloaded and read into PARI GP via the command
...
The file SHINTANI contains 11 examples of Shintani domains E1,...,E11. It consists of one long line of text of the form 
